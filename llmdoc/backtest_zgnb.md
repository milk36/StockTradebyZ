...
# 回测所有可用日期
python backtest_zgnb.py --data-dir ./data --all
...
2. 汇总报告表格（包含所有日期的统计）
3. 每个日期的详细CSV文件
4. 汇总报告日志文件 `backtest_summary_all.log`
...
汇总报告 - 所有日期回测结果
============================================================
日期           总数     成功     盈利     亏损     平均收益       胜率
------------------------------------------------------------
2026-01-05   216    216    154    62     3.27%      71.3%
2026-01-06   103    103    49     54     0.61%      47.6%
...
------------------------------------------------------------
